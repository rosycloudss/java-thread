...
public class MyThread extends Thread {
     ...
     *          2.使用stop方法强行终止线程，但是不推荐使用这个方法，因为stop和suspend及resume一样都是作废过期的方法，使用他们可能产生不可预料的结果（导致一些请理性的工作无法完成）
     *          3.使用interrupt方法中断线程
     *线程的优先级：
     *      线程的优先级分为 1~10 默认情况下，线程的优先级为 5  如果线程的优先级小于1 或大于 10 则会报错
     *
     */
    @Override
